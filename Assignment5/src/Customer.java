...
public class Customer {
	...
	private static void rentInsurancedVehicle(ArrayList<Vehicle> list, int days, double most, double least) {
		for (Vehicle v : list) {
	...
	private static void rentMotorbike(ArrayList<Vehicle> list, int days, double most, double least) {
		for (Vehicle v : list) {
			if (v.getRental(days) <= most && v.getRental(days) >= least) {
	...
	private static void readVehicle(ArrayList<Vehicle> list) {
		try {
